...
int clicoAux = 0;
int botaoAcionado = 0;
int led0FoiAcionado = 0;
int led2FoiAcionado = 0;
int led2Acesso = 0;
int led4FoiAcionado = 0;
int led5FoiAcionado = 0;
int led6FoiAcionado = 0;
